...
class SFTPUploadModel(BaseModel):
    ...
    target_path = models.CharField(max_length=512, verbose_name="uploaded file path on the remote server")
    status = models.IntegerField(choices=StatusType.choices, default=StatusType.PENDING, verbose_name="status")
