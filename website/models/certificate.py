...
class AcmeAccount(BaseModel):
    ...
    server = models.URLField(
        default="https://acme-v02.api.letsencrypt.org/directory", verbose_name="签发服务"
    )
    eab_kid = models.CharField(
        max_length=512, null=True, blank=True, verbose_name="kid"
    )
    eab_hmac_key = models.CharField(
        max_length=512, null=True, blank=True, verbose_name="hmac_key"
    )
